...
$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{user_updated_message}","$vars_file");
...
$gip->update_user("$client_id","$id","$name","$group_id","$phone","$email","$comment");
