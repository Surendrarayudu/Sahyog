...
print "<td><form method=\"POST\" name=\"admin2\" action=\"$server_proto://$base_uri/res/ip_insert_llclient.cgi\">\n";
print "<input type=\"text\" name=\"ll_client_name\" size=\"10\" maxlength=\"30\"></td></tr>\n";
...
print "document.admin2.ll_client_add.focus();\n";
print "</script>\n";
