...
if ( $lang_vars =~ /vars_he$/ ) {
	print "<tr><td colspan=\"4\" $align1><b>$$lang_vars{redes_message} ${red}/${BM}</b><input type=\"hidden\" name=\"red_num\" value=\"$red_num\"><input type=\"hidden\" name=\"ip_version\" value=\"$ip_version\"><p> </td></tr>\n";
} else {
	print "<tr><td colspan=\"4\" $align1><b>${red}/${BM} $$lang_vars{redes_message}</b><input type=\"hidden\" name=\"red_num\" value=\"$red_num\"><input type=\"hidden\" name=\"ip_version\" value=\"$ip_version\"><p> </td></tr>\n";
}
...
<tr><td $align1><br><input type="hidden" name="client_id" value="$client_id"><input type="submit" value="$$lang_vars{query_message}" name=\"B1\" class=\"input_link_w\"></td></tr>
