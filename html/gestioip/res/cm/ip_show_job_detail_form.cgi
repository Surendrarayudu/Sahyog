...
print "<p><br><b>$$lang_vars{show_job_details_massage}</b><br>\n";
print "<form name=\"show_job_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/cm/ip_show_job_detail.cgi\">\n";
...
print "</select>\n";
print "</td></tr>\n";
print "<tr><td><br><input type=\"submit\" value=\"$$lang_vars{submit_message}\" name=\"B2\" class=\"input_link_w_net\"></td></tr>\n";
print "</td></tr></table>\n";
print "</form>\n";
