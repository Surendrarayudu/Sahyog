...
my $comment=$ll_client_values[0]->[3] || "";
my $description=$ll_client_values[0]->[4] || "";
...
#my @values_clientes=$gip->get_ll_client("$client_id");
#my $anz_ll_client_clients=$gip->count_ll_client_clients("$client_id");

print "<p>\n";
print "<form name=\"modll_client_form\" method=\"POST\" action=\"./ip_mod_llclient.cgi\">\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td $align>";
print "$$lang_vars{ll_client_name_message}</td><td><input type=\"text\" name=\"name\" value=\"$name\" size=\"10\" maxlength=\"30\"></td></tr>\n";
