...
print "<span style=\"float: $ori\"><input type=\"submit\" class=\"input_link_w\" title=\"$$lang_vars{create_message}\" style=\"cursor:pointer;\" onClick=\"document.pressed=this.value\" VALUE=\"$$lang_vars{create_message}\"></span>\n";
print "<span style=\"float: $ori\"><input type=\"submit\" title=\"$$lang_vars{export_network_list_message}\" class=\"input_link_w\" style=\"cursor:pointer;\" onClick=\"document.pressed=this.value\" VALUE=\"$$lang_vars{export_message}\"></span>\n";
print "</form>\n";
print "<br>\n";
